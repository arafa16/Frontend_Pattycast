...
const Form = (props) => {
    ...
    useEffect(()=>{
        setUserId(users && users.id);
        setStatusId(status && status.id);
    },[users, status]);
    ...
    },[isPengajuanSuccess, isPengajuanError, messagePengajuan])
                ...
                <form onSubmit={submitPengajuan}>
                    <div className="grid grid-cols-12 gap-4 mt-5 gap-y-5">
                        ...
                        <div className="flex items-center justify-center col-span-12 mt-5 intro-y sm:justify-end">
                            ...
                            {isPengajuanLoading ? <LoadingIcon icon="ball-triangle" color="white" className="w-5 h-5" /> : 'Submit Pengajuan'}
                            </Button>
                        </div>
                    </div>
                </form>
