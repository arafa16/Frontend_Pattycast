...
const Data = (props : any) => {
    const {costCenters, clickStatus, status, allData, nextPage, prevPage, page, allPage} = props;
        ...
        <>
            ...
            <div className="grid grid-cols-12 mt-5 box mb-8">
                ...
                <div className="flex flex-wrap items-center justify-between w-full px-5 pt-5 pb-5 mb-4 border-b gap-y-3 border-slate-200/60 dark:border-darkmode-400">
                    <Button 
                        onClick={()=>{navigate('/formCostCenter')}} 
                ...
                <div className="overflow-x-auto sm:overflow-x-visible">
                    {costCenters.rows && costCenters.rows.map((data : any, index : any) => (
                    <div 
                        key={index} 
                        className="intro-y"
                        onClick={()=>navigate(`/viewCostCenter/${data.uuid}`)}
                    >
                        <div
                        className={clsx([
